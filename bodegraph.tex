...
\begin{description}
\item[version 1.5] 10/17/2021 : Bug fixes and implementation of a \verb"linear" package option to plot more accurate linear approximation of phase plots (by Rushikesh Kamalapurkar).
